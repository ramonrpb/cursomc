package com.ramonbarros.cursomc.domain;
...
public class Pedido implements Serializable{
	...
	public Pedido(Integer id, Date instante, Cliente cliente, Endereco enderecoDeEnterega) {
		super();
		this.id = id;
	...
	public Endereco getEnderecoDeEnterega() {
		return enderecoDeEnterega;
	}
