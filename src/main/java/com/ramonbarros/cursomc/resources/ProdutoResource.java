...
import com.ramonbarros.cursomc.dto.ProdutoDTO;
import com.ramonbarros.cursomc.resources.utils.URL;
import com.ramonbarros.cursomc.services.ProdutoService;
...
public class ProdutoResource {
	...
	public ResponseEntity<Page<ProdutoDTO>> findPage(
		...
		Page<Produto> lista= service.search(nomeDecoded, ids, page, linesPerPage, orderBy, directions);
